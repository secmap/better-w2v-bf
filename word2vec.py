...
flags.DEFINE_string("model_meta_file", None, "The saved model meta file.")
flags.DEFINE_string(
...
class Options(object):
  ...
  def __init__(self):
    ...
    self.model_meta_file = FLAGS.model_meta_file
...
def main(_):
  ...
  with tf.Graph().as_default(), tf.Session() as session:
    ...
    if FLAGS.interactive and opts.model_meta_file and opts.plk_table:
      with tf.device("/cpu:0"):
        model = Word2Vec(opts, session, False, bf)
      model.saver = tf.train.import_meta_graph(os.path.join(opts.save_path, opts.model_meta_file))
